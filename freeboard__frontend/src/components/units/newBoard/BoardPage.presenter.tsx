      ...
      <Box>
        ...
        <Body>
          ...
          <PhotoBtnWrapper>
            ...
            <Photo ref={imgRef1} type="file" onChange={onChangeFile(1)}></Photo>
            <Photo ref={imgRef2} type="file" onChange={onChangeFile(2)}></Photo>
            <Photo ref={imgRef3} type="file" onChange={onChangeFile(3)}></Photo>
          </PhotoBtnWrapper>
          <MainWrarper>
        ...
        <EnrollmentWapper>
          ...
          {!data ? (
            <Enrollment onClick={handleClickCreateBoard}>등록하기</Enrollment>
          ) : (
            <Enrollment onClick={hadleUpdateBoard}>수정하기</Enrollment>
          )}
        </EnrollmentWapper>
      </Box>
    </Container>
